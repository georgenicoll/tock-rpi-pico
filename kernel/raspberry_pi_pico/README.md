# This directory copied from the tock repository - KEEP IN SYNC if updating tock #

Copied using `cp -r ../tock/boards/raspberry_pi_pico raspberry_pi_pico`.
And cargo.toml directories re-pointed.
